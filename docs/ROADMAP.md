...
### ملاحظة تستحق مرحلة خاصة: الطلب المتقطّع

منتج له مبيعات في 22 من 44 شهراً، وآخر شهر صفر → `Naive` يفوز بالاختبار
الخلفي (التنبؤ بالصفر يصيب كثيراً حين نصف الأشهر أصفار) → التوصية
**«أنتج 0»**. RMSE يقول إنه الأفضل؛ مدير الإنتاج يقول إنه عديم الفائدة.

هذا نمط معروف اسمه intermittent demand، وله طرق مخصّصة (Croston، TSB)
لا يغطيها أي من النماذج السبعة الحالية. **مرشّح قوي لمرحلة مستقبلية** —
فـ 39% من الكتالوج متقطّع.
