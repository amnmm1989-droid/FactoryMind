...
# بداية السلسلة الزمنية في البيانات الحالية (ديسمبر 2022).
# ETS/SARIMA لا يعنيهما التاريخ المطلق — فقط التردد الشهري والدورة الموسمية.
# Prophet يعنيه (موسمية سنوية تُحسب من اليوم في السنة)، لذا يبقى متوافقاً
# مع التقويم الحقيقي طالما البيانات تبدأ فعلاً من هذا التاريخ.
