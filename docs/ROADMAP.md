...
## 1. الحبيبة الزمنية المرنة 🔴 الأولوية القصوى

**العطل — مقيس لا مفترَض:** ملف بيانات أسبوعية يُقبل الآن ويُعامَل كأشهر.
30 أسبوعاً (سبعة أشهر واقعياً) تُقرأ كـ30 شهراً، و`SEASONAL_PERIODS = 12`
يبحث عن دورة كل **12 أسبوعاً** ويسمّيها سنوية. التحذير الوحيد الذي يظهر
(`timeline_gaps`) مضلّل — لا فجوات أصلاً.

**النظام لا يفشل — يُنتج تحليلاً خاطئاً يبدو سليماً.** وهذا أسوأ من الرفض،
ومخالف لكل ما بُني عليه المشروع.

المطلوب:
- اكتشاف الحبيبة من التواريخ: يومي / أسبوعي / شهري / ربعي
- اشتقاق الدورة الموسمية منها: 7 / 52 / 12 / 4 بدل الثابت 12
- رفض ما لا يُفهَم صراحةً
...
خضراء، وهذا سلوك دائم لا بند يُنجَز. الرصيد الحالي: **337 اختباراً**.
